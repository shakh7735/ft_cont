...
// template <typename OutStr, typename V>
// OutStr &operator<<( OutStr &put, const ft::vector<V>  &fix)
// {
//     V *p = fix.data();
//     size_t n = 0;
//     put << "{";
...
// // template<class Os, class Cont> Os& operator<<(Os& os, const Cont& vec) {
// //     os << "{";
// //     for (Cont const& i : vec) { os << ' ' << i; }
// //     return os << " } ";
// // }
